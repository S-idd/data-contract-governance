...
- Java source preparation baseline: `71e0823ac359f63c536ef19f0b79352ba81c1ef5`. Final Java build commit for the next assembly (Tomcat 10.1.59): `d54a518c3b308d1c54a440f016d81086e0a73155`, pushed to origin/main. This supersedes `dac3ed509d03e1bef75c47b497ca80bbdd1f2e04`, which still describes the existing Step 7 archives. Build fresh Java JARs from the new immutable revision; do not relabel old binaries. Packaging-only files are independently hashed; any later Java build-input change requires a new pin and retesting.
...
- Rust source and frozen artifact revision for the next assembly: **`32ca579095ed5b91749b8c33999556624e58758f`** in the companion `dcgaimodel` repository, pushed to its `main` branch. This updates Cargo/Parquet from 57 to 60 and removes Thrift 0.17.0; the four frozen files are byte-identical to the prior pin. Build the executable and copy all four frozen files from this same immutable commit, not `WEEK1`.
