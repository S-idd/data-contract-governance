...
this exact package is now detected and stopped; unrelated listeners are left untouched.
...
misconfigurations, and zero secrets. macOS ARM64 passed full native extracted-package
acceptance, including authentication, AI outage/recovery, repeated lifecycle, and cleanup
of a manually started Rust process. Linux x64 passed an emulated smoke test including
that process-cleanup case. Linux x64 WSL2 acceptance remains the final platform-specific
technical check for these regenerated bytes.
